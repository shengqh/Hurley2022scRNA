...
parSampleFile2=''
parSampleFile3=''
parFile1='C:/projects/scratch/cqs/shengq2/paula_hurley_projects/20210303_scRNA_human/seurat_sct_celltype_rename_edgeR_betweenCluster_byCell/result/PH_scRNA.edgeR.files.csv'
parFile2=''
parFile3=''
outputDirectory='.'
gseaDb='C:/projects/database/gsea/v7.5/'; gseaJar='gsea-cli.bat'; 
#gseaCategories=c('h.all.v7.5.symbols.gmt', 'c2.all.v7.5.symbols.gmt', 'c5.all.v7.5.symbols.gmt', 'c6.all.v7.5.symbols.gmt', 'c7.all.v7.5.symbols.gmt'); makeReport=0;
gseaCategories=c('h.all.v7.5.symbols.gmt', 'c2.all.v7.5.symbols.gmt'); makeReport=0;

setwd('C:/projects/scratch/cqs/shengq2/paula_hurley_projects/20210303_scRNA_human/seurat_sct_celltype_rename_edgeR_betweenCluster_byCell_GSEA/result')
...
if(file.exists(parFile1)){
  ...
  preRankedGeneFileTable$V2 = preRankedGeneFileTable$comparison
