...
parSampleFile2=''
parSampleFile3=''
parFile1='C:/projects/scratch/cqs/shengq2/paula_hurley_projects/20210303_scRNA_human/seurat_sct_celltype_rename_edgeR_inCluster_byCell/result/PH_scRNA.edgeR.files.csv'
parFile2=''
parFile3=''
outputDirectory='.'
...
setwd('C:/projects/scratch/cqs/shengq2/paula_hurley_projects/20210303_scRNA_human/seurat_sct_celltype_rename_edgeR_inCluster_byCell_GSEA/result')
